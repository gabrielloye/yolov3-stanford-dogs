...
def train(
    ...
    if resume:
        ...
        mod_weights = removekey(checkpoint['model'],['module_list.81.conv_81.weight', 'module_list.81.conv_81.bias', 'module_list.93.conv_93.weight', 'module_list.93.conv_93.bias', 'module_list.105.conv_105.weight', 'module_list.105.conv_105.bias'])
        print(len(checkpoint['model']))
        # Load weights to resume from
        model.load_state_dict(mod_weights, strict=False)
        print('resuming training and loading weights from latest')
        ...
        for i, (name, p) in enumerate(model.named_parameters()):
            p.requires_grad = True if (p.shape[0] == 18) else False
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-cfg', type=str, default='cfg/yolo.data', help='yolo.data file path')
